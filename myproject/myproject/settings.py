...
SECRET_KEY = 'django-insecure-27ro=3chc1#b6ypkm*-as+jz0++84$0gtxx4qlm7kyr6x_v)u_'
...
INSTALLED_APPS = [
    ...
    # Custom apps
    'users',  # User authentication and CRUD app
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydatabase',  # Use your actual database name
...
# REST Framework & JWT Authentication Configuration
REST_FRAMEWORK = {
